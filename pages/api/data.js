export default {
  Trending: [
    {
      id: 1,
      title:
        "Vote For The Environment: Quantitative shareholder resolution votes on environmental issues",
      subtitle:
    ...
    {
      id: 2,
      title: "23 Best islands to visit in 2023: unique island escapes",
      subtitle:
    ...
    {
      id: 3,
      title: "Big Tech Is Really Bad at Firing People",
      subtitle:
        "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.",
      category: "Business, Travel",
      img: "/images/img3.jpg",
      description: `
      Tech companies have laid off tens of thousands of workers over the past few months in an industry-wide downsizing that executives have blamed on over-hiring during the pandemic.
            `,
  ...
  Posts: [
    ...
    {
      id: 2,
      title: "23 Best islands to visit in 2023: unique island escapes",subtitle:
        "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.",
      category: "Business, Travel",
      img: "/images/img2.jpg",
      description: `
